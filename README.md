...
The entire contents of the output text file generated by run_analysis.R containing feature descriptions was manually copied and appended to the manually created CodeBook.md file using RStudio.
